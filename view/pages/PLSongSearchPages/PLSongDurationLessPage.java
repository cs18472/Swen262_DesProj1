...
import model.searches.PLSongLessSearch;
import view.ScannerCLI;
import view.commands.PLSongSearchCommand;
import view.pages.LandingPage;
import view.pages.Page;

public class PLSongDurationLessPage extends Page{
    private final ScannerCLI scanner;

    public PLSongDurationLessPage(ScannerCLI scanner){
    ...
    public void menu() {
        System.out.println("------------------------------------------------");
        System.out.println("Please enter the song duration that you want to search less than.");
    ...
    public void interpretInput(String str) {
        ...
        if (checkQuit(str)){
            ...
            PLSongLessSearch songSearch = new PLSongLessSearch();
