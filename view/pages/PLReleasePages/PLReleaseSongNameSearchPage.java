...
import model.searches.PLReleaseSongNameSearch;
import view.ScannerCLI;
import view.commands.PLReleaseSearchCommand;
import view.pages.LandingPage;
import view.pages.Page;

public class PLReleaseSongNameSearchPage extends Page{
    private final ScannerCLI scanner;

    public PLReleaseSongNameSearchPage(ScannerCLI scanner){
    ...
    public void menu() {
        System.out.println("------------------------------------------------");
        System.out.println("Please enter the name of the song whos releases you are searching for.");
    ...
    public void interpretInput(String str) {
        ...
        if (checkQuit(str)){
            ...
            PLReleaseSongNameSearch releaseSearch = new PLReleaseSongNameSearch();
