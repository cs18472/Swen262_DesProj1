...
import model.searches.DBReleaseSongGUIDSearch;
import view.ScannerCLI;
import view.commands.DBReleaseSearchCommand;
import view.pages.LandingPage;
import view.pages.Page;

public class DBReleaseSongGUIDSearchPage extends Page{
    private final ScannerCLI scanner;

    DBReleaseSongGUIDSearchPage(ScannerCLI scanner){
    ...
    public void menu() {
        System.out.println("------------------------------------------------");
        System.out.println("Please enter the song's GUID that you wish to search for.");
    ...
    public void interpretInput(String str) {
        ...
        if (checkQuit(str)){
            DBReleaseSongGUIDSearch releaseSearch = new DBReleaseSongGUIDSearch();
