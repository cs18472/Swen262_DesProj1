...
import model.searches.DBReleaseArtistGUIDSearch;
import view.ScannerCLI;
import view.commands.DBReleaseSearchCommand;
import view.pages.LandingPage;
import view.pages.Page;

public class DBReleaseArtistGUIDSearchPage extends Page{
    private final ScannerCLI scanner;

    DBReleaseArtistGUIDSearchPage(ScannerCLI scanner){
    ...
    public void menu() {
        System.out.println("------------------------------------------------");
        System.out.println("Please enter the artist's GUID that you wish to search for.");
    ...
    public void interpretInput(String str) {
        ...
        if (checkQuit(str)){
            DBReleaseArtistGUIDSearch releaseSearch = new DBReleaseArtistGUIDSearch();
