...
/**
 * This will create a search strategy for finding artists by their type.
 */
public class PLArtistTypeSearch implements Searcher{
    ...
    public List<LibraryElement> doSearch(List<LibraryElement> elements, String input) {
        ...
        for (LibraryElement element: elements) {
            name = element.getType().toLowerCase();
